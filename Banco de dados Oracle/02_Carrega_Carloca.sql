...
insert into loc_depto values (    0, 'Conselho Acionistas' ,  1000000);
insert into loc_depto values (   10, 'Financeiro'          , 20000000);
insert into loc_depto values (   11, 'TI - Desenvolvimento', 25000000);
insert into loc_depto values (   12, 'TI - Dados          ', 25000000);
insert into loc_depto values (   13, 'TI - Infraestrutura ', 25000000);
insert into loc_depto values (   31, 'Vendas - Região Norte',  500000);
insert into loc_depto values (   32, 'Vendas - Região Sul',    500000);
insert into loc_depto values (   33, 'Vendas - Região Sudeste',500000);
insert into loc_depto values (   34, 'Vendas - Região Nordeste',50000);
insert into loc_depto values (   35, 'Vendas - Regiao Centro Oeste',500000);
insert into loc_depto values (   41, 'Operacional - Região Norte', 200000);
insert into loc_depto values (   42, 'Operacional - Região Sul',  2000000);
insert into loc_depto values (   43, 'Operacional - Região Sudeste', 2000000);
insert into loc_depto values (   44, 'Operacional - região Nordeste', 1000000);
insert into loc_depto values (   45, 'Operacional - Região Centro Oeste', 100000);
insert into loc_depto VALUES (   50, 'Administracao Geral', 10000000);
insert into loc_depto VALUES (   51, 'Prospeccao de Clientes', 200000);

-- Carregar Classe --
insert into loc_classe values (    1, 'Administrativo I');
insert into loc_classe values (    2, 'Administrativo II');
insert into loc_classe values (    3, 'Administrativo III');
insert into loc_classe values (   11, 'Profissional I');
insert into loc_classe values (   12, 'Profissional II');
insert into loc_classe values (   13, 'Profissional III');

-- Carregar Funcionario --
insert into loc_funcionario values ( 1,  'Yuri Gagari', to_date('01011999','ddmmyyyy'), null, null, 23567.98, 25, 50, 5, 13, 'Presidente');
insert into loc_funcionario values ( 2,  'Maria Oliveira',  	to_date('0101200','ddmmyyyy'), 1 , null, 12258.45, 10, 50, 3, 3, 'Diretora Administrativa');
insert into loc_funcionario values ( 3,  'Simone Batista'	, 	to_date('18122000','ddmmyyyy'), 1 , null, 6985.63, 7, 50, 3, 13, 'Diretora Tecnica');
insert into loc_funcionario values ( 4,  'Adriana Doretto'	, 	to_date('18052001','ddmmyyyy'), 3 , null, 2145.74, 3, 42, 2, 3, 'Gerente Financeiro'); 
insert into loc_funcionario values ( 5,  'MariaLinda Sauro'	, 	to_date('13032001','ddmmyyyy'), 3 , null, 2145.74, 3, 42, 2, 3, 'Gerente Comercial');
insert into loc_funcionario values ( 6,  'Marinaldo de Souza', 	to_date('13032002','ddmmyyyy'), 2 , null, 2145.74, 3, 50, 2, 13, 'Gerente de TI');
insert into loc_funcionario values ( 7,  'Jose Carlos da Silva', 	to_date('13042003','ddmmyyyy'), 2 , null, 2145.74, 3, 42, 2, 13, 'Gerente de Fabrica');
insert into loc_funcionario values ( 8,  'Paulo Norberto',   	to_date('13032002','ddmmyyyy'), 2 , null, 2145.74, 3,  11, 2, 12, 'Analista de Sistemas');
insert into loc_funcionario values ( 9,  'Carlo Noronha',     	to_date('13032002','ddmmyyyy'), 2 , null, 2145.74, 3, 42, 2, 12, 'Supervisor de Linha');
insert into loc_funcionario values ( 10, 'Diogo Sanguino',  	to_date('13032002','ddmmyyyy'), 3 , null, 2145.74, 3, 33, 2, 1, 'Analista de Atendimento');
insert into loc_funcionario values ( 11, 'Eleonora Sintra', 	to_date('13032002','ddmmyyyy'), 3 , null, 2145.74, 3, 33, 2, NULL, 'Analista de Atendimento');
insert into loc_funcionario values ( 12, 'Helio Gomes',     	to_date('13032002','ddmmyyyy'), 6 , null, 5145.74, 3, 33, 2, 1, 'Analista de Atendimento');
insert into loc_funcionario values ( 13, 'Rogerio Reis Lima', 	to_date('13032002','ddmmyyyy'), 6 , null, 5145.74, 3, 33, 2, 11, 'Tecnico de Atendimento');
insert into loc_funcionario values ( 14, 'Geraldo Reis Lima',  	to_date('13032002','ddmmyyyy'),   6 , null, 5145.74, 3, 33, 2, 11, 'Tecnico de Atendimento');
insert into loc_funcionario values ( 15, 'Eduardo Satoru Sakai', 	to_date('13032002','ddmmyyyy'), 6 , null, 2145.74, 3, 33, 2, 11, 'Tecnico de Atendimento');
insert into loc_funcionario values ( 16, 'Daiane dos Santos',  	to_date('13032002','ddmmyyyy'), 4 , null, 4145.74, 3, 11, 1, 12, 'Programador');
insert into loc_funcionario values ( 17, 'Aline de Oliveira', 	to_date('13032002','ddmmyyyy'), 4 , null, 2145.74, 3, 11, 1, 12, 'Programador');
insert into loc_funcionario values ( 18, 'Jozivaldo Abreu',  	to_date('13032002','ddmmyyyy'), 4 , null, 3145.74, 3, 11, 1, 12, 'Programador');
insert into loc_funcionario values ( 19, 'Ricardo Genaro',  	to_date('13032002','ddmmyyyy'), 4 , null, 1145.00, 3, 11, 1, 12, 'Programador');
insert into loc_funcionario values ( 20, 'Marcos da Cunha', 	to_date('11012000','ddmmyyyy'), 4 , null, 2145.74, 3, 11, 1, 12, 'Programador');
insert into loc_funcionario values ( 21, 'Gustavo Lopes', 	to_date('15122008','ddmmyyyy'), null , 08352851488, 22541, 21, 50, 1, NULL, 'Filho do Dono');
insert into loc_funcionario values ( 22, 'Ana Raquel Fernandes'	, 	to_date('18052001','ddmmyyyy'), 2 , null, 5000.00, 3, 12, 2, 12, 'Analista de ETL' ); 
insert into loc_funcionario values ( 23, 'Beatriz Oliveira'	, 	to_date('22112004','ddmmyyyy'), 10 , null, 4500.00, 3, 12, 2, 12, 'Analista de Visualizacao');
insert into loc_funcionario values ( 24, 'Cristina Murakami'	, 	to_date('18011998','ddmmyyyy'), 2 , null, 7500.00, 3, 12, 2, 12, 'Analista de BI'); 
insert into loc_funcionario values ( 25, 'Dayse Soares'	, 	to_date('22122004','ddmmyyyy'), 10 , null, 8500.00, 3, 12, 2, 12, 'Cientista de Dados');
insert into loc_funcionario values ( 26, 'Salvino Lopes', 	to_date('15122008','ddmmyyyy'), null , 08352851488, 22541, 21, 50, 1, NULL, 'Filho do Dono');
insert into loc_funcionario values ( 27, 'Larissa Almeira'	, 	to_date('22102006','ddmmyyyy'), 10 , null, 8500.00, 3, 12, 2, 12, 'Cientista de Dados');
insert into loc_funcionario values ( 28, 'Danielle da Silva', 	to_date('13122007','ddmmyyyy'), null , 08352851488, 7450, 21, 12, 1, 12, 'Analista de ETL');
...
begin
   ...
   loop
	v_dat_pedido := to_date('19/01/2010','dd/mm/yyyy');
        for y in 1..3 loop
...
--        dbms_output.put_line('primeiro cursor');
      v_item := 0;
      for y in (select v.nr_placa, g.vl_locacao_diaria val 
   	...
   	loop
        ...
        qtd   := qtd + 1;
        if qtd = 1000 then
--            dbms_output.put_line('registros inseridos---> '||qtd);
            commit;
            qtd := 0;
        end if;           
	end loop;
...
update loc_funcionario set nm_cargo = 'Analista de Atendimento Sr' where cd_func  = 20;
...
UPDATE loc_cliente set nr_estrelas = 5 
  where mod(cd_cliente,5) = 0;
UPDATE loc_cliente set nr_estrelas = 4 
  where mod(cd_cliente,13) = 0;
UPDATE loc_cliente set nr_estrelas = 3 
  where mod(cd_cliente,3) = 0;
UPDATE loc_cliente set nr_estrelas = 2 
  where mod(cd_cliente,17) = 0;
UPDATE loc_cliente set nr_estrelas = 1 
  where mod(cd_cliente,11) = 0;
UPDATE loc_cliente set nr_estrelas = 0
  where mod(cd_cliente,7) = 0;
